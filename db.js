...
DbManager = (function() {
  ...
  var server = new mongodb.Server( mongoCon.hostname, parseInt(mongoCon.port), { safe: false });
  var db     = new mongodb.Db(mongoCon.auth_ex[0], server, { native_parser: true });
