...
exports.db2 = function(callback_function) {
  //TODO: Maybe we shouldn't use same connection...... Big queries may start blocking.
  //To change, simply stop using global client, and remember to close connection at the end of each request.
 if (!GlobalClient) {

  // Get the MongoLab URI
  var mongoLab = url.parse(process.env.MONGOLAB_URI);
